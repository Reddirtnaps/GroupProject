...
<body>
	<div class="container">
		<h3>Create a new animal exhibit</h3>
			...
			<button class="btn btn-dark">Submit exhibit edits</button>
		</form:form>
		<hr>
		<div><a style="padding: 2px 6px; border: 1px solid gray; border-radius: 5px; text-decoration: none; color: black;" href="/exhibits/delete/${exhibit.id}">Delete Exhibit</a></div>
	</div>
</body>
</html>