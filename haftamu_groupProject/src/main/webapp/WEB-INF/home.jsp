...
<section id="title">
  <h2 class="text-center"> Welcome To Zoo World</h2>
   ...
   <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
	<ul class="navbar-nav ml-auto">
		<li class="nav-item">
		 ...
		 <li class="nav-item">
			 <a class= "nav-link text-secondary" href = "http://localhost:8080/register">Membership</a>
		 </li>
		 <li class="nav-item">
			 <a class= "nav-link text-secondary" href = "http://localhost:8080/buyticket">BuyTickets</a>
		 </li>
	</ul>
	</div>
</nav>
